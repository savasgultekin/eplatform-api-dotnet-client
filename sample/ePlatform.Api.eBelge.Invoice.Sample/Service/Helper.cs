...
namespace ePlatform.Api.eBelge.Invoice.Sample.Service
{
    public class Helper
    {
        ...
        public MemoryStream UnzipFile(Stream zipStream)
        {
            ...
            using (ZipArchive zip = new ZipArchive(zipStream))
            {
                ...
                {
                    throw new System.Exception("Zip içerisinde dosya yok.");
                }
                if (zip.Entries.Count > 1)
                {
                    throw new System.Exception("Zip içerisinde birden fazla dosya bulunamaz.");
                }
